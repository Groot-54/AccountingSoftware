...
import { TrendingUp, Save, X, CheckCircle, AlertCircle } from 'lucide-react';
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600">Record payment received from customer</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mt-8 flex gap-4">
          ...
          >
            <Save size={20} />
            {isPending ? 'Saving...' : 'Save Credit Entry'}
          </button>
          <button
            type="button"
            onClick={handleReset}
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 className="font-medium text-blue-900 mb-2">💡 Credit Entry Tips:</h3>
        <ul className="text-sm text-blue-800 space-y-1">
          <li>• Credit increases the customer's balance (they owe you less or you owe them more)</li>
          <li>• Use this when you receive payment from a customer</li>
